    ...
    <AppLayout title="Dashboard">
        ...
        <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-end gap-2">
                <PrimaryButton @click="openPrescriptionModal">Nova Receita</PrimaryButton>
                <PrimaryButton @click="showSaleModal = true">Nova Venda</PrimaryButton>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow text-sm text-gray-800 dark:text-gray-100">
                        ...
                        <!-- Endereços -->
                        <div v-if="client.addresses?.length" class="mt-4">
                ...
                <div class="md:col-span-3">
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
                        <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Receitas</h3>
