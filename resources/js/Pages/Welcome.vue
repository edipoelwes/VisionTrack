...
<template>
    <Head title="Ótica - Sua Visão é Nossa Prioridade" />
        ...
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-2xl font-bold text-blue-600">ÓticaPro</span>
                </div>

                <div class="hidden md:flex items-center space-x-8">
                    <a href="#home" class="text-gray-700 hover:text-blue-600 font-medium">Início</a>
                    <a href="#services" class="text-gray-700 hover:text-blue-600 font-medium">Serviços</a>
    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <span class="text-xl font-bold">ÓticaPro</span>
                    </div>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2025 ÓticaPro. Todos os direitos reservados.</p>
